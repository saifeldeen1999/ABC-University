...
<div class="container">
    <c:url var="edit_department_url" value="/department/editDepartment"/>
    <form:form action="${edit_department_url}" method="put" modelAttribute="Department">
        <div class="row">
            <div class="col-25">
                <label>Department title:</label>
            </div>
            <div class="col-75">
                <input type="text" id="title" name="title" value="${theDepartment.title}" placeholder="Department title"/>
            </div>
        </div>
        <div class="row">
